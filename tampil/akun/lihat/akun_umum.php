...
<!--                        <li role="separator" class="divider"></li>-->
        ...
        <!-- Menu -->
        <div class="menu">
            <?php include '../../../komponen/menu_lihat_akun.php' ?>
        </div>
        <!-- #Menu -->
        <!-- Footer -->
        <div class="legal">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-hover dashboard-task-infos">
                                ...
                                <?php
                                $no=1;
                                $query = mysqli_query($db, "SELECT * FROM wisba_account WHERE status_account='Umum' ");
                                ...
                                <tr>
                                    ...
                                    <td>'.$d['nik_account'].'</td>
                                    <td>'.$d['alamat_account'].'</td>
                                    <td>'.$d['agama_account'].'</td>
                                    <td>'.$d['jabatan_account'].'</td>
                                    <td>'.$d['kota_account'].'</td>
                                    <td>'.$d['kab_account'].'</td>
                                    <td>
                                    <div class="round-img">
                                         <a href="#"><img class="rounded-circle" src="'.$d['foto_front_account'].'" style="width: 80px;height: 80px"></a>
                                    </div>
                                    </td>
                                    <td>
                                    <div class="round-img">
                                         <a href="#"><img class="rounded-circle" src="'.$d['ttd_account'].'" style="width: 80px;height: 80px"></a>
                                    </div>
                                    </td>
                                    <td>'.$d['lat_account'].'</td>
                                    ...
                                    <td>
                                    <span>
                                    <a href="../edit/akun_umum.php?id_account='.$d['id_account'].'">
                                    <button type="submit" class="btn btn-warning waves-effect">Edit</button></a>  
                                    </span>
                                    </td>
                                    <td>
                                    <span>
                                    <a href="../../../proses/akun/umum_hapus.php?id_account='.$d['id_account'].'">
