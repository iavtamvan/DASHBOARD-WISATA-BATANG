...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <!-- Menu -->
        <div class="menu">
            <?php include '../../../komponen/menu_lihat_umkm.php' ?>
        </div>
        <!-- #Menu -->
        <!-- Footer -->
        <div class="legal">
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2>UMKM Belum Terverifikasi</h2>
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-hover dashboard-task-infos">
                                ...
                                <?php
                                $no=1;
                                $query = mysqli_query($db, "SELECT * FROM wisba_umkm WHERE status_umkm='Belum Terverifikasi' ");
                                ...
                                <tr>
                                    ...
                                    <td>'.$d['nama_umkm'].'</td>
                                     <td>
                                    <div class="round-img">
                                         <a href="#"><img class="rounded-circle" src="'.$d['gambar_thumbnail_umkm'].'" style="width: 80px;height: 80px"></a>
                                    </div>
                                    </td>
                                    <td>'.$d['alamat_umkm'].'</td>
                                    <td>'.$d['jarak_umkm'].'</td>
                                    ...
                                    <td>
                                    <div class="round-img">
                                         <a href="#"><img class="rounded-circle" src="'.$d['gambar_1_umkm'].'" style="width: 80px;height: 80px"></a>
                                    </div>
                                    </td>
                                    <td>
                                    <div class="round-img">
                                         <a href="#"><img class="rounded-circle" src="'.$d['gambar_2_umkm'].'" style="width: 80px;height: 80px"></a>
                                    </div>
                                    </td>
                                    <td>'.$d['detail_deskripsi_umkm'].'</td>
                                    <td>'.$d['like_umkm'].'</td>
                                    <td>'.$d['dislike_umkm'].'</td>
                                    <td>'.$d['kategori_umkm'].'</td>
                                    <td>'.$d['status_umkm'].'</td>
                                    <td>
                                    <span>
                                    <a href="../../../proses/umkm/verifikasi.php?id_umkm='.$d['id_umkm'].'">
                                    <button type="submit" class="btn btn-success waves-effect">Verifikasi</button></a>  
                                    </span>
                                    </td> 
                                    <td>
                                    <span>
                                    <a href="../edit/umkm_belum_terverifikasi.php?id_umkm='.$d['id_umkm'].'">
                                    <button type="submit" class="btn btn-warning waves-effect">Edit</button></a>  
                                    </span>
                                    </td>
                                    <td>
                                    <span>
                                    <a href="../../../proses/umkm/belum_terverifikasi_hapus.php?id_umkm='.$d['id_umkm'].'">
