                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-hover dashboard-task-infos">
                                ...
                                <?php
                                $no=1;
                                $query = mysqli_query($db, "SELECT * FROM wisba_umkm WHERE status_umkm='Terverifikasi' ");
                                ...
                                <tr>
                                    ...
                                    <td>'.$d['status_umkm'].'</td>
                                     <td>
                                    <span>
                                    <a href="../../../proses/umkm/batal_verifikasi.php?id_umkm='.$d['id_umkm'].'">
                                    <button type="submit" class="btn btn-success waves-effect">Batal Verifikasi</button></a>  
                                    </span>
                                    </td> 
                                    <td>
                                    <span>
                                    <a href="../edit/umkm_terverifikasi.php?id_umkm='.$d['id_umkm'].'">
                                    <button type="submit" class="btn btn-warning waves-effect">Edit</button></a>  
                                    </span>
                                    </td>
                                    <td>
                                    <span>
                                    <a href="../../../proses/umkm/terverifikasi_hapus.php?id_umkm='.$d['id_umkm'].'">
