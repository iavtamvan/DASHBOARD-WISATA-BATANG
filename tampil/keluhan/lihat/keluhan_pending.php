                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-hover dashboard-task-infos">
                                ...
                                <?php
                                $query = mysqli_query($db, "SELECT * FROM wisba_keluhan WHERE status_keluhan='Pending' ");
                                $no = 1;
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <span>
                                    <a href="../../../proses/keluhan/publikasi.php?id_keluhan='.$d['id_keluhan'].'">
                                    <button type="submit" class="btn btn-success waves-effect">Publikasi</button></a>  
                                    </span>
                                    </td> 
                                    <td>
                                    <span>
                                    <a href="../edit/keluhan_pending.php?id_keluhan='.$d['id_keluhan'].'">
                                    <button type="submit" class="btn btn-warning waves-effect">Edit</button></a>  
                                    </span>
                                    </td>
                                    <td>
                                    <span>
                                    <a href="../../../proses/keluhan/pending_hapus.php?id_keluhan='.$d['id_keluhan'].'">
